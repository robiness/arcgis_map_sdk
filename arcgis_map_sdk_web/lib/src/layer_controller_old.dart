...
//     JsView view,
//   ) async {
//     print('createFeatureLayer called');
...
//     void Function(dynamic)? onPressed,
//   ) async {
//     print('createGraphicsLayer called');
...
//   }) {
//     print('polygonContainsPoint called');
...
//     print('_isPointInPolygon called');
...
//     print('getOnClickListener called');
...
//     print('refreshOnClickStreams called');
...
//     print('_getCurrentOnClickStreams called');
...
//     print('refreshZoomStreams called');
...
//     print('_getCurrentZoomStreams called');
...
//     print('getCenterPosition called');
//     if (!streamsRefreshed
...
//     print('refreshCenterPositionStreams called');
...
//     print('_getCurrentCenterPositionStreams called');
...
//     JsEsriMap map,
//   ) {
//     print('getVisibleGraphicsStream called');
//     if (!streamsRefreshed
...
//     JsEsriMap map,
//   ) {
//     print('refreshVisibleGraphicsStreams called');
...
//     JsEsriMap map,
//   ) {
//     print('_getCurrentVisibleGraphicsStreams called');
...
//     JsEsriMap map,
//   ) {
//     print('getVisibleGraphicIds called');
...
//     print('refreshBoundsStreams called');
...
//     print('_getCurrentBoundsStreams called');
...
//     print('getAttributionStream called');
...
//     print('refreshAttributionStreams called');
...
//     print('_getCurrentAttributionStreams called');
...
//   }) {
//     print('updateGraphicSymbol called');
...
//   }) async {
//     print('updateFeatureLayer called');
...
//     required JsView view,
//   }) async {
//     print('moveCameraToPoints called');
...
//   void /*JsHandle*/ registerGlobalPointerMoveEventHandler(
//       JsEsriMap map, JsView view) {
//     print('registerGlobalPointerMoveEventHandler called');
...
//   ) {
//     print('_setGraphicsHoverStatus called');
//     // if (resultsLength < 1 ||
...
//     List<String>? excludeAttributeValues,
//   }) {
//     print('_removeGraphicsFromLayer called');
...
//   }) {
//     print('setGroundElevation called');
...
//     required String? apiKey,
//   }) {
//     print('moveBaseMapLabelsToBackground called');
...
// }
//
// // --- Assumed Definitions based on Documentation ---
// // Your wrapper for the ArcGIS View object would have a method like this,
// // correctly typed to return a JSPromise.
// extension type View(JSObject _) implements JSObject {
//   // external JSPromise hitTest(JSAny? event);
// // ... other view methods like 'on'
// }
//
// // A type-safe wrapper for the HitTestResult object.
// extension type JsHitTestResult(JSObject _) implements JSObject {
//   // Assuming 'results' is a property on the HitTestResult object
