...
//
//       final config = (esri! as JSObject).getProperty('config'.toJS);
//       print('🔧 [MapController] Got esri.config object: ${config != null}');
//
//       (config! as JSObject).setProperty('apiKey'.toJS, _mapOptions.apiKey.toJS);
...
//       ((JSAny? newValue, JSAny? oldValue) {
//         final loaded = (newValue as JSBoolean).toDart;
...
//     String layerId,
//   ) async {
//     if (globalContext.getProperty('FeatureLayer'.toJS) == null) {
//       await (loadFeatureLayer() as JSPromise).toDart;
//     }
